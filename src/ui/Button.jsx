...
export default function Button({ children, to, type }) {
  ...
  const style = {
    ...
    secondary : 'px-3 py-4 inline-block rounded-full bg-stone-200  text-sm font-semibold text-stone-800 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2'
  }
  if (to)
    return (
